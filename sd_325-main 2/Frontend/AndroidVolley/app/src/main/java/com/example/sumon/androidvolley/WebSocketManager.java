    ...
    public void connectWebSocket(String serverUrl) {
        try {
            ...
            if (webSocketClient.isOpen()) {
                Log.d("IIIIISS", "OPPPEN");
            }else {
                Log.d("connction", "failed");
            }
    ...
    private class MyWebSocketClient extends WebSocketClient {
        ...
        public void onOpen(ServerHandshake handshakedata) {
            ...
            if (webSocketListener != null) {
                ...
                webSocketListener.onWebsocketOpen(webSocketClient, handshakedata);
            }
        }
        ...
        public void onMessage(String message) {
            ...
            if (webSocketListener != null) {
                ...
                webSocketListener.onWebsocketMessage(webSocketClient, message);
                AdminDashActivity.message = message;
                AdminDashActivity.makeToast(message);
                //new snackbar
            }
        }
        ...
        public void onClose(int code, String reason, boolean remote) {
            ...
            if (webSocketListener != null) {
                ...
                webSocketListener.onWebsocketClose(webSocketClient, code, reason, remote);
            }
        }
        ...
        public void onError(Exception ex) {
            ...
            if (webSocketListener != null) {
               // webSocketListener.onWebSocketError(ex);
                webSocketListener.onWebsocketError(webSocketClient, ex);
